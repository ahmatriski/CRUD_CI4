...
<header>
	...
	<div class="heroe">
		...
		<h1>Welcome to CodeIgniter AHMAT RISKI RAMADHAN</h1>

		<h2>Belajar Bersama , Pintar Bersama</h2>
...
<section>
	...
	<p>Saya adalah Mahasiswa Politeknik Negeri Lampung</p>

	<p>Jurusan Ekonomi dan Bisnis , Program Study Manajemen Informatika</p>

	<pre><code></code></pre>
	<pre><code></code></pre>
	<p ALIGN="CENTER">JANGAN LUPA TITIK KOMA !!!!!</p>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> AHMAT RISKI RAMADHAN.</p>
